...
- [ACPI Concepts](./dvfs/ACPI_Concepts/summary_ACPI_Concepts.md)
- [ACPI P-state](./dvfs/acpi_p_state/summary_processor_power_states.md)
- [Declaring Processors](./dvfs/Declaring_Processors/summary_Declaring_Processors.md)
- [Processor Configuration and Control](./dvfs/Processor_Configuration_and_Control/summary_Processor_Configuration_and_Control.md)
